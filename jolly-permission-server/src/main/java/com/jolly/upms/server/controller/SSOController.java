package com.jolly.upms.server.controller;

import com.jolly.framework.insipid.plugin.permission.client.shiro.session.UpmsSession;
import com.jolly.framework.insipid.plugin.permission.client.shiro.session.UpmsSessionDao;
import com.jolly.upms.common.constant.UpmsResult;
import com.jolly.upms.common.constant.UpmsResultConstant;
...
import com.jolly.insipid.permission.common.base.BaseController;
...
/**
 * 单点登录管理
 * Created by jolly on 2016/12/10.
 */
@Controller
@RequestMapping("/sso")
