package com.jolly.framework.insipid.plugin.permission.client.shiro.session;

import com.jolly.framework.insipid.plugin.permission.client.util.SerializableUtil;
...
public class UpmsSessionDao extends CachingSessionDAO {
    ...
    // 会话key
    private final static String ZHENG_UPMS_SHIRO_SESSION_ID = "jolly-upms-shiro-session-id";
    // 全局会话key
    private final static String ZHENG_UPMS_SERVER_SESSION_ID = "jolly-upms-server-session-id";
    // 全局会话列表key
    private final static String ZHENG_UPMS_SERVER_SESSION_IDS = "jolly-upms-server-session-ids";
    // code key
    private final static String ZHENG_UPMS_SERVER_CODE = "jolly-upms-server-code";
    // 局部会话key
